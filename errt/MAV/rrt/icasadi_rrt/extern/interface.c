 ...
 *   + n2: 0
 *
 * Generated at: 2023-02-13 09:08:23.478273
 *
 */
#include <stdlib.h>
 ...
 */
extern int phi_DzTrIEitxRCBzMifHCSn(
 ...
 */
extern int grad_phi_DzTrIEitxRCBzMifHCSn(
    const casadi_real** arg, 
    casadi_real** res, 
    casadi_int* iw, 
    casadi_real* w, 
 ...
 */
extern int mapping_f1_DzTrIEitxRCBzMifHCSn(
    const casadi_real** arg, 
    casadi_real** res, 
    casadi_int* iw, 
    casadi_real* w, 
 ...
 */
extern int mapping_f2_DzTrIEitxRCBzMifHCSn(
    const casadi_real** arg, 
    casadi_real** res, 
    casadi_int* iw, 
    casadi_real* w, 
 ...
 * |------------------- uxip_space ------------------------------|
 */
static casadi_real uxip_space[NU_RRT
                              +NXI_RRT
                              +NP_RRT];
...
static void copy_args_into_uxip_space(const casadi_real** arg) {
    ...
    for (i=0; i<NXI_RRT; i++) uxip_space[NU_RRT+i] = arg[1][i];  /* copy xi */
    for (i=0; i<NP_RRT; i++)  uxip_space[NU_RRT+NXI_RRT+i] = arg[2][i];  /* copy p  */
}
...
static void copy_args_into_up_space(const casadi_real** arg) {
    int i;
    for (i=0; i<NU_RRT; i++) uxip_space[i] = arg[0][i];  /* copy u  */
    for (i=0; i<NP_RRT; i++) uxip_space[NU_RRT+NXI_RRT+i] = arg[1][i];  /* copy p  */
}
...
int cost_function_rrt(const casadi_real** arg, casadi_real** res) {
    const casadi_real* args__[COST_SZ_ARG_RRT] =
             {uxip_space,  /* :u  */
              uxip_space + NU_RRT,  /* :xi  */
              uxip_space + NU_RRT + NXI_RRT};  /* :p  */
    copy_args_into_uxip_space(arg);

    result_space_cost[0] = res[0];
    return phi_DzTrIEitxRCBzMifHCSn(
        args__,
        result_space_cost,
...
int grad_cost_function_rrt(const casadi_real** arg, casadi_real** res) {
    ...
    return grad_phi_DzTrIEitxRCBzMifHCSn(
        args__,
        result_space_grad,
...
int mapping_f1_function_rrt(const casadi_real** arg, casadi_real** res) {
    ...
    /*
     * Call auto-generated function mapping_f1_DzTrIEitxRCBzMifHCSn
     * Implemented in: icasadi/extern/auto_casadi_mapping_f1.c
     */
    return mapping_f1_DzTrIEitxRCBzMifHCSn(
        args__,
        result_space_f1,
...
int mapping_f2_function_rrt(const casadi_real** arg, casadi_real** res) {
    ...
    /*
     * Call auto-generated function mapping_f2_DzTrIEitxRCBzMifHCSn
     * Implemented in: icasadi/extern/auto_casadi_mapping_f2.c
     */
    return mapping_f2_DzTrIEitxRCBzMifHCSn(
        args__,
        result_space_f2,
