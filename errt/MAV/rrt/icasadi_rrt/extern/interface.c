 ...
 */
extern int open_mapping_f1_rrt(
    const casadi_real** arg,
    casadi_real** res,
    casadi_int* iw,
    casadi_real* w,
 ...
 */
extern int open_mapping_f2_rrt(
    const casadi_real** arg,
    casadi_real** res,
    casadi_int* iw,
    casadi_real* w,
...
//#ifdef PRECONDITIONING_RRT
/*
 * CasADi interface for cost function preconditioning
 */
extern int open_preconditioning_w_cost_rrt(
    const casadi_real** arg,
    casadi_real** res,
    casadi_int* iw,
    casadi_real* w,
 ...
 */
extern int open_preconditioning_w_f1_rrt(
    const casadi_real** arg,
    casadi_real** res,
    casadi_int* iw,
    casadi_real* w,
 ...
 */
extern int open_preconditioning_w_f2_rrt(
    const casadi_real** arg,
    casadi_real** res,
    casadi_int* iw,
    casadi_real* w,
 ...
 */
extern int open_initial_penalty_rrt(
    const casadi_real** arg,
    casadi_real** res,
    casadi_int* iw,
    casadi_real* w,
 ...
 */
#if COST_SZ_IW_RRT > 0
static casadi_int allocated_i_workspace_cost[COST_SZ_IW_RRT];  /* cost (int )  */
#else
static casadi_int *allocated_i_workspace_cost = NULL;
#endif

#if GRAD_SZ_IW_RRT > 0
static casadi_int allocated_i_workspace_grad[GRAD_SZ_IW_RRT];  /* grad (int )  */
#else
static casadi_int *allocated_i_workspace_grad = NULL;
#endif

#if F1_SZ_IW_RRT > 0
static casadi_int allocated_i_workspace_f1[F1_SZ_IW_RRT];      /* f1 (int )    */
#else
static casadi_int *allocated_i_workspace_f1 = NULL;
#endif

#if F2_SZ_IW_RRT > 0
static casadi_int allocated_i_workspace_f2[F2_SZ_IW_RRT];      /* f2 (int )    */
#else
static casadi_int *allocated_i_workspace_f2 = NULL;
#endif

#if W_COST_SZ_IW_RRT > 0
static casadi_int allocated_i_workspace_w_cost[W_COST_SZ_IW_RRT];      /* w_cost (int )    */
#else
static casadi_int *allocated_i_workspace_w_cost = NULL;
#endif

#if W1_SZ_IW_RRT > 0
static casadi_int allocated_i_workspace_w1[W1_SZ_IW_RRT];      /* w1 (int )    */
#else
static casadi_int *allocated_i_workspace_w1 = NULL;
#endif

#if W2_SZ_IW_RRT > 0
static casadi_int allocated_i_workspace_w2[W2_SZ_IW_RRT];      /* w2 (int )    */
#else
static casadi_int *allocated_i_workspace_w2 = NULL;
#endif

#if INIT_PENALTY_SZ_IW_RRT > 0
static casadi_int allocated_i_workspace_init_penalty[INIT_PENALTY_SZ_IW_RRT];      /* init_penalty (int )    */
#else
 ...
 */
#if COST_SZ_W_RRT > 0
static casadi_real allocated_r_workspace_cost[COST_SZ_W_RRT];  /* cost (real)  */
#else
...
#if GRAD_SZ_W_RRT > 0
static casadi_real allocated_r_workspace_grad[GRAD_SZ_W_RRT];  /* grad (real ) */
#else
static casadi_real *allocated_r_workspace_grad = NULL;
#endif

#if F1_SZ_W_RRT > 0
static casadi_real allocated_r_workspace_f1[F1_SZ_W_RRT];      /* f1 (real )   */
#else
static casadi_real *allocated_r_workspace_f1 = NULL;
#endif

#if F2_SZ_W_RRT > 0
static casadi_real allocated_r_workspace_f2[F2_SZ_W_RRT];      /* f2 (real )   */
#else
static casadi_real *allocated_r_workspace_f2 = NULL;
#endif

#if W_COST_SZ_W_RRT > 0
static casadi_real allocated_r_workspace_w_cost[W_COST_SZ_W_RRT];      /* w_cost (real )   */
#else
static casadi_real *allocated_r_workspace_w_cost = NULL;
#endif

#if W1_SZ_W_RRT > 0
static casadi_real allocated_r_workspace_w1[W1_SZ_W_RRT];      /* w1 (real )   */
#else
static casadi_real *allocated_r_workspace_w1 = NULL;
#endif

#if W2_SZ_W_RRT > 0
static casadi_real allocated_r_workspace_w2[W2_SZ_W_RRT];      /* w2 (real )   */
#else
static casadi_real *allocated_r_workspace_w2 = NULL;
#endif

#if INIT_PENALTY_SZ_W_RRT > 0
static casadi_real allocated_r_workspace_init_penalty[INIT_PENALTY_SZ_W_RRT];      /* init_penalty (real )   */
#else
 ...
 * Result workspaces
 */
#if COST_SZ_RES_RRT > 0
static casadi_real *result_space_cost[COST_SZ_RES_RRT];       /* cost (res )  */
#else
static casadi_real **result_space_cost = NULL;
#endif

#if GRAD_SZ_RES_RRT > 0
static casadi_real *result_space_grad[GRAD_SZ_RES_RRT];        /* grad (res )  */
#else
...
#if F1_SZ_RES_RRT > 0
static casadi_real *result_space_f1[F1_SZ_RES_RRT];            /* f1 (res )    */
#else
...
#if F2_SZ_RES_RRT > 0
static casadi_real *result_space_f2[F2_SZ_RES_RRT];            /* f2 (res )    */
#else
static casadi_real **result_space_f2 = NULL;
#endif


#if W_COST_SZ_RES_RRT > 0
static casadi_real *result_space_w_cost[W_COST_SZ_RES_RRT];            /* w_cost (res )    */
#else
...
#if W1_SZ_RES_RRT > 0
static casadi_real *result_space_w1[W1_SZ_RES_RRT];            /* w1 (res )    */
#else
...
#if W2_SZ_RES_RRT > 0
static casadi_real *result_space_w2[W2_SZ_RES_RRT];            /* w2 (res )    */
#else
static casadi_real **result_space_w2 = NULL;
#endif


#if INIT_PENALTY_SZ_RES_RRT > 0
static casadi_real *result_space_init_penalty[INIT_PENALTY_SZ_RES_RRT];            /* init_penalty (res )    */
#else
...
#define IDX_XI_RRT NU_RRT
#define IDX_P_RRT  IDX_XI_RRT + NXI_RRT
#define IDX_WC_RRT IDX_P_RRT + NP_RRT
#define IDX_W1_RRT IDX_WC_RRT + 1
#define IDX_W2_RRT IDX_W1_RRT + N1_RRT
#define N_UXIPW_RRT IDX_W2_RRT + N2_RRT

static casadi_real uxip_space[N_UXIPW_RRT];

/**
 * Return scaling factor of cost function (getter)
 */
casadi_real get_w_cost_rrt(void) {
    return uxip_space[IDX_WC_RRT];
}

/**
 * This function should be called upon initialisation. The sets all w's to 1.
 */
void init_interface_rrt(void) {
    unsigned int i;
    unsigned int offset = IDX_WC_RRT;
    unsigned int len = N1_RRT + N2_RRT + 1;
    for (i = 0; i < len; i++) {
...
static void copy_args_into_uxip_space(const casadi_real** arg) {
    unsigned int i;
    for (i=0; i<NU_RRT; i++)  uxip_space[i] = arg[0][i];  /* copy u  */
    for (i=0; i<NXI_RRT; i++) uxip_space[IDX_XI_RRT+i] = arg[1][i];  /* copy xi */
    for (i=0; i<NP_RRT; i++)  uxip_space[IDX_P_RRT+i] = arg[2][i];  /* copy p  */
}
...
static void copy_args_into_up_space(const casadi_real** arg) {
    unsigned int i;
    for (i=0; i<NU_RRT; i++) uxip_space[i] = arg[0][i];  /* copy u  */
    for (i=0; i<NP_RRT; i++) uxip_space[IDX_P_RRT+i] = arg[1][i];  /* copy p  */
}
 ...
 */
int cost_function_rrt(const casadi_real** arg, casadi_real** res) {
    const casadi_real* args__[COST_SZ_ARG_RRT] =
             {uxip_space,  /* :u  */
              uxip_space + IDX_XI_RRT,   /* :xi  */
              uxip_space + IDX_P_RRT };  /* :p  */
 ...
 */
int grad_cost_function_rrt(const casadi_real** arg, casadi_real** res) {
    const casadi_real* args__[GRAD_SZ_ARG_RRT] =
            { uxip_space,  /* :u  */
              uxip_space + IDX_XI_RRT,  /* :xi  */
              uxip_space + IDX_P_RRT};  /* :p   */
    copy_args_into_uxip_space(arg);
    result_space_grad[0] = res[0];
    return open_grad_phi_rrt(
        args__,
        result_space_grad,
 ...
 */
int mapping_f1_function_rrt(const casadi_real** arg, casadi_real** res) {
    /* Array of pointers to where (u, p) are stored */
    const casadi_real* args__[F1_SZ_ARG_RRT] =
            {uxip_space,  /* :u   */
            uxip_space + IDX_P_RRT};  /* :p  */
    ...
    /*
     * Call auto-generated function open_mapping_f1_rrt
     * Implemented in: icasadi/extern/auto_casadi_mapping_f1.c
     */
    return open_mapping_f1_rrt(
        args__,
        result_space_f1,
 ...
 * - `res = {F1}`, where `F1` is a pointer-to-double
 */
int mapping_f2_function_rrt(const casadi_real** arg, casadi_real** res) {
    /* Array of pointers to where (u, p) are stored */
    const casadi_real* args__[F2_SZ_ARG_RRT] =
            {uxip_space,  /* :u   */
             uxip_space + IDX_P_RRT};  /* :p   */
    /* Copy given data to variable `uxip_space` */
    copy_args_into_up_space(arg);
    ...
    /*
     * Call auto-generated function open_mapping_f2_rrt
     * Implemented in: icasadi/extern/auto_casadi_mapping_f2.c
     */
    return open_mapping_f2_rrt(
        args__,
        result_space_f2,
 ...
 *  - arg = {u, theta}
 */
static int preconditioning_w_cost_function_rrt(const casadi_real** arg) {
    /* Array of pointers to where (u, p) are stored */
    const casadi_real* args__[W_COST_SZ_ARG_RRT] =
            {uxip_space,  /* :u   */
             uxip_space + IDX_P_RRT};  /* :p   */
    /* Copy given data to variable `uxip_space` */
    copy_args_into_up_space(arg);
     ...
     * (memory has been allocated - see beginning of this file)
     */
    result_space_w_cost[0] = uxip_space + IDX_WC_RRT;
    /*
     * Call auto-generated function open_preconditioning_w_cost_rrt
     * Implemented in: icasadi/extern/auto_preconditioning_functions.c
     */
    return open_preconditioning_w_cost_rrt(
        args__,
        result_space_w_cost,
 ...
 */
static int preconditioning_w1_function_rrt(const casadi_real** arg) {
    /* Array of pointers to where (u, p) are stored */
    const casadi_real* args__[W1_SZ_ARG_RRT] =
            {uxip_space,  /* :u   */
             uxip_space + IDX_P_RRT};  /* :p   */
    /* Copy given data to variable `uxip_space` */
    copy_args_into_up_space(arg);
     ...
     * (memory has been allocated - see beginning of this file)
     */
    result_space_w1[0] = uxip_space + IDX_W1_RRT;
    /*
     * Call auto-generated function open_preconditioning_w_f1_rrt
     * Implemented in: icasadi/extern/auto_preconditioning_functions.c
     */
    return open_preconditioning_w_f1_rrt(
        args__,
        result_space_w1,
 ...
 */
static int preconditioning_w2_function_rrt(const casadi_real** arg) {
    /* Array of pointers to where (u, p) are stored */
    const casadi_real* args__[W2_SZ_ARG_RRT] =
            {uxip_space,  /* :u   */
             uxip_space + IDX_P_RRT};  /* :p   */
    /* Copy given data to variable `uxip_space` */
    copy_args_into_up_space(arg);
     ...
     * (memory has been allocated - see beginning of this file)
     */
    result_space_w2[0] = uxip_space + IDX_W2_RRT;
    /*
     * Call auto-generated function open_preconditioning_w_f2_rrt
     * Implemented in: icasadi/extern/auto_preconditioning_functions.c
     */
    return open_preconditioning_w_f2_rrt(
        args__,
        result_space_w2,
 ...
 */
int init_penalty_function_rrt(const casadi_real** arg, casadi_real** res) {
    /* Array of pointers to where (u, p) are stored */
    const casadi_real* args__[INIT_PENALTY_SZ_ARG_RRT] =
            {uxip_space,  /* :u   */
             uxip_space + IDX_P_RRT};  /* :theta   */
    /* Copy given data to variable `uxip_space` */
    copy_args_into_up_space(arg);
    /*
     ...
     * Implemented in: icasadi/extern/auto_preconditioning_functions.c
     */
    return open_initial_penalty_rrt(
        args__,
 ...
 * - `arg = {u, p}`, where `u` and `p` are pointer-to-double
 */
int preconditioning_www_rrt(const casadi_real** arg) {
    int status_ = 0;
    status_ += preconditioning_w1_function_rrt(arg);
    status_ += preconditioning_w2_function_rrt(arg);
    status_ += preconditioning_w_cost_function_rrt(arg);
    return status_;
}
 ...
 * Compile with -DTEST_INTERFACE
 */
#if defined(TEST_INTERFACE) && defined(PRECONDITIONING_RRT)

static casadi_real u_test[NU_RRT];
static casadi_real p_test[NP_RRT];
...
static void print_static_array(void){
    ...
    for (i=0; i<NXI_RRT; i++){
        printf("xi[%2d] = %4.2f\n", i, uxip_space[IDX_XI_RRT+i]);
    }
    for (i=0; i<NP_RRT; i++){
        printf("p[%2d] = %4.2f\n", i, uxip_space[IDX_P_RRT+i]);
    }
    printf("w_cost = %g\n", uxip_space[IDX_WC_RRT]);
#if N1_RRT > 0
     for (i=0; i<N1_RRT; i++){
        printf("w1[%2d] = %g\n", i, uxip_space[IDX_W1_RRT+i]);
    }
#endif /* IF N1 > 0 */
#if N2_RRT > 0
     for (i=0; i<N2_RRT; i++){
        printf("w2[%2d] = %g\n", i, uxip_space[IDX_W2_RRT+i]);
    }
#endif /* IF N2 > 0 */
}
...
static casadi_real test_initial_penalty(void) {
    ...
    init_penalty_function_rrt(args, res);
...
#endif /* END of TEST_INTERFACE and PRECONDITIONING_RRT */