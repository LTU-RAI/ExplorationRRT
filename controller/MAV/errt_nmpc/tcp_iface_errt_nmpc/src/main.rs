///
/// Auto-generated TCP server for optimizer: errt_nmpc
///
...
/// Port
/// Can be overriden by the user
const BIND_PORT_DEFAULT: u32 = 2769;
...
fn execution_handler(
    ...
    match initial_guess {
        ...
        Some(u0) => {
            if u0.len() != ERRT_NMPC_NUM_DECISION_VARIABLES {
    ...
    if parameter.len() != ERRT_NMPC_NUM_PARAMETERS {
...
fn main() {
    let matches = App::new("OpEn TCP Server [errt_nmpc]")
        .version("0.0.0")
        .author("John Smith")
